...
import com.ninebythree.nutriscanph.detection.env.Utils;
...
public class TFLiteClassifier implements Classifier
{
     ...
     */
    public static TFLiteClassifier create(final AssetManager assetManager, final String modelFilename, final String labelFilename, final boolean isQuantized, final int inputSize) throws IOException
    {
...
//        float[][][] outbuf = new float[1][output_box][labels.size() + 5];
        ...
        //Log.d("TFLiteClassifier", "mObjThresh: " + getObjThresh());
        ...
        //Log.d("TFLiteClassifier", "out[0] detect start");
        ...
        for (int i = 0; i < output_box; ++i){
            ...
            if (confidenceInClass > getObjThresh()) {
                ...
                //Log.d("TFLiteClassifier", Float.toString(xPos) + ',' + yPos + ',' + w + ',' + h);
        ...
        //Log.d("TFLiteClassifier", "detect end");
